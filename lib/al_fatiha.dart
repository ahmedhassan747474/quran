...
class al_fatiha extends StatefulWidget {
  @override
  _al_fatihaState createState() => _al_fatihaState();
}
...
AudioCache player = AudioCache(prefix: 'music/');
...
class _al_fatihaState extends State<al_fatiha> with TickerProviderStateMixin {
  ...
  Widget returnButton() {
    return Container(
      ...
      child: RaisedButton(
        onPressed: () {
          [Navigator.pop(context), audioPlayer.stop(), audioCache.clearCache()];
        },
        child: Text('الرجوع'),
